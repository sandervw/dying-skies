...
const morrowind: Record<Role, InstrumentSpec> = {
  drone: {
    ...
    options: {
      ...
      envelope: { attack: 1.2, decay: 2.0, sustain: 0.9, release: 3.0 },
      portamento: 0.2,
    },
  ...
  pad: {
    ...
    options: {
      ...
      envelope: { attack: 2.5, decay: 3.0, sustain: 0.75, release: 4.0 },
    },
    register: 3, hold: 6, gain: 0.5,
    filter: { type: "lowpass", frequency: 800, rolloff: -24 },
    effects: [
      [Tone.Chorus, { frequency: 0.8, delayTime: 4.0, depth: 0.6, wet: 0.45 }],
  ...
  sparkle: {
    ...
    options: {
      ...
      envelope: { attack: 0.01, decay: 1.8, sustain: 0.15, release: 3.0 },
    },
    register: 5, hold: 2, gain: 0.45,
  ...
  lead: {
    ...
    options: {
      ...
      envelope: { attack: 0.8, decay: 1.5, sustain: 0.85, release: 2.5 },
      portamento: 0.1,
    },
    register: 6, hold: 4, gain: 0.35,
  ...
  counter: {
    ...
    options: {
      ...
      envelope: { attack: 1.2, decay: 1.5, sustain: 0.7, release: 2.0 },
    },
...
const kingsfield: Record<Role, InstrumentSpec> = {
  ...
  pad: {
    ...
    options: {
      ...
      envelope: { attack: 2.2, decay: 1.8, sustain: 0.75, release: 3.5 },
    },
    register: 2, hold: 6, gain: 0.5,
    filter: { type: "lowpass", frequency: 450, rolloff: -12 },
    effects: [
      [Tone.Chorus, { frequency: 0.5, delayTime: 3.5, depth: 0.7, wet: 0.4 }],
  ...
  lead: {
    ...
    options: {
      ...
      envelope: { attack: 1.2, decay: 1.5, sustain: 0.75, release: 2.2 },
      portamento: 0.25,
    },
    register: 2, hold: 4, gain: 0.45,
  ...
  counter: {
    ...
    options: {
      noise: { type: "pink" },
      envelope: { attack: 1.8, decay: 2.0, sustain: 0.4, release: 3.0 },
    },
    register: 2, hold: 6, gain: 0.25,
    filter: { type: "bandpass", frequency: 2200, rolloff: -24, Q: 6.0 },
    effects: [
      [Tone.PingPongDelay, { delayTime: "8n", feedback: 0.45, wet: 0.4 }],
...
const majorasmask: Record<Role, InstrumentSpec> = {
  drone: {
    ...
    options: {
      ...
      envelope: { attack: 0.6, decay: 1.8, sustain: 0.85, release: 2.2 },
      portamento: 0.08,
    },
  ...
  pad: {
    ...
    options: {
      ...
      envelope: { attack: 0.45, decay: 1.2, sustain: 0.75, release: 1.8 },
    },
    register: 3, hold: 6, gain: 0.5,
  ...
  counter: {
    ...
    options: {
      ...
      envelope: { attack: 0.003, decay: 0.75, sustain: 0.0, release: 0.6 },
    },
    register: 4, hold: 2, gain: 0.45,
    filter: { type: "lowpass", frequency: 900, rolloff: -12 },
    effects: [
      [Tone.StereoWidener, { width: 0.5, wet: 0.4 }],
...
const deusex: Record<Role, InstrumentSpec> = {
  drone: {
    ...
    options: {
      ...
      envelope: { attack: 2.0, decay: 0.0, sustain: 1.0, release: 3.5 },
      portamento: 0.5,
    },
  ...
  pad: {
    ...
    options: {
      oscillator: { type: "fatsawtooth", count: 3, spread: 25 },
      envelope: { attack: 0.35, decay: 0.8, sustain: 0.75, release: 1.2 },
    },
  ...
  sparkle: {
    ...
    options: {
      ...
      envelope: { attack: 0.003, decay: 0.45, sustain: 0.08, release: 0.5 },
    },
  ...
  lead: {
    ...
    options: {
      ...
      voice0: {
        ...
        filterEnvelope: { attack: 0.04, decay: 0.2, sustain: 0.5, release: 0.2, octaves: 1.2 },
...
const aom: Record<Role, InstrumentSpec> = {
  drone: {
    ...
    options: {
      ...
      envelope: { attack: 0.01, decay: 0.4, sustain: 0.75, release: 0.35 },
      portamento: 0.05,
    },
    register: 1, hold: 8, gain: 0.9,
  ...
  pad: {
    ...
    options: {
      oscillator: { type: "fatsawtooth", count: 3, spread: 18 },
      envelope: { attack: 1.2, decay: 0.8, sustain: 0.85, release: 2.4 },
    },
    register: 3, hold: 6, gain: 0.5,
    filter: { type: "bandpass", frequency: 950, rolloff: -12 },
    effects: [
      [Tone.Chorus, { frequency: 1.2, delayTime: 3.5, depth: 0.6, wet: 0.45 }],
  ...
  sparkle: {
    ...
    filter: { type: "lowpass", frequency: 3200, rolloff: -12 },
    effects: [
      [Tone.Chorus, { frequency: 1.5, delayTime: 3.5, depth: 0.3, wet: 0.2 }],
  ...
  lead: {
    ...
    options: {
      ...
      envelope: { attack: 0.003, decay: 0.8, sustain: 0.0, release: 0.3 },
      portamento: 0.035,
    },
    register: 4, hold: 2, gain: 0.45,
    filter: { type: "lowpass", frequency: 1800, rolloff: -24 },
    effects: [
      [Tone.Chorus, { frequency: 1.5, delayTime: 3.5, depth: 0.3, wet: 0.25 }],
      [Tone.FeedbackDelay, { delayTime: "8n.", feedback: 0.28, wet: 0.22 }],
    ],
  },
  counter: {
    ...
    options: {
      oscillator: { type: "fatsawtooth", count: 3, spread: 25 },
      envelope: { attack: 1.8, decay: 2.0, sustain: 0.9, release: 3.0 },
    },
    register: 2, hold: 6, gain: 0.45,
