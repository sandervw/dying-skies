...
// root seed from token ElgUZvDLNbT0k4aH4UzvBihSnW1aufuc0-9CYM-cnXg.
const ROOT_SEED: Seed = [
  18, 88, 20, 102, 240, 203, 53, 180, 244, 147, 134, 135, 225, 76, 239, 6,
  40, 82, 157, 109, 90, 185, 251, 156, 211, 239, 66, 96, 207, 156, 157, 120,
];
