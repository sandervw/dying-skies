...
// root seed from token clDDU-81H8IpQrTXS9eYYLk-uzE1w_YVepos_f8E2QQ.
const ROOT_SEED: Seed = [
  114, 80, 195, 83, 239, 53, 31, 194, 41, 66, 180, 215, 75, 215, 152, 96,
  185, 62, 187, 49, 53, 195, 246, 21, 122, 154, 44, 253, 255, 4, 217, 4,
];
