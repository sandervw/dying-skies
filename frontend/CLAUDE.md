...
Vite + React SPA, Canvas 2D visual layer. Standards and system conventions live in the root `CLAUDE.md`; this file adds only frontend specifics.

Backend and auth are out of scope; data is stubbed or session-local until the backend exists.
